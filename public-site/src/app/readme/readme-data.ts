...
export const ABSTRACT_PARAGRAPHS: string[] = [
  'A method and apparatus for investigating whatever is interesting, comprising: a curiosity-driven video production pipeline (70+ videos, 30,000 subscribers), a retired epistemic intelligence engine that measured its own cognition across seven axes, a knowledge management workbench designed for a brain that does not hold still, a self-improving plugin ecosystem with Bayesian confidence updating across 250+ typed knowledge claims, a government property sales portal, a compliance tracking system that consolidated a seven-step six-software SOP into four button presses, and a community music festival serving 3,000 attendees with 30+ musical acts and 50+ vendors annually.',
...
export const CLAIMS: ClaimData[] = [
  {
    number: 1,
    title: 'Theseus: Epistemic Intelligence Engine (retired)',
    description:
      'Retired. An epistemic intelligence engine that comprised a seven-pass pipeline discovering semantic, structural, and logical connections across heterogeneous knowledge objects, with self-measurement across seven axes. IQ: 17.6 to 35.7 in a single activation session. Named for Claude Shannon\'s maze-navigating mouse.',

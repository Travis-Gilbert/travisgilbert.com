 ...
 *
 * The old site linked Spacetime Atlas to /spacetime (a d3-geo globe).
 * That globe is not part of this static extract, so the card stays a
    ...
    <>
      ...
      <div className="space-y-6">
        {EXPERIMENTS.map((exp) => {
          ...
          return (
            <RoughBox key={exp.slug} tint={exp.tint} padding={24}>
              <article aria-label={`${exp.title} (${status.label})`}>
